...
exports.run = (client, message, args, gameData, p1, p2, p3, p4) => {
	...
	const mainEmbed = new Discord.RichEmbed()
	     ...
	     .setFooter('Si un bug/crash de la partie survient veuillez contacter MTG#8211 avec un screen de ce message (au moment ou l\'erreur a eu lieu)')
